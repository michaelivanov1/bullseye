...
const About = ({ aboutSectionRef }) => {
  ...
  return (
    <div ref={aboutSectionRef} className="bg-about-section-banner w-full">
      <div className="flex h-screen">
        <div className="w-2/5 text-left">
          <h1 className="text-primary text-lg lg:text-2xl mb-4 pl-24 pt-24">
            Why Bullseye?
          </h1>
          <h1 className="text-header text-4xl lg:text-7xl mb-4 pl-24">
            Simplify
            <br />
            Visualization
          </h1>
          ...
          <div className="pl-24 pt-20 flex w-10/12">
            ...
            <div className="flex flex-col">
              <h1 className="text-header pl-12 text-lg lg:text-2xl">
                Real-Time Updates
              </h1>
              <h1 className="text-subheader pl-12 text-sm">
      ...
      <div className="bg-about-section-banner h-screen w-4/5 mx-auto">
        <div className="">
          <h1 className="text-header text-4xl lg:text-7xl">Dive Deep</h1>
